...
public class JsonConverter {
    ...
    public static JsonResponseError getError(String response) {
        JsonResponseError error = new JsonResponseError();
        ObjectMapper mapper = new ObjectMapper();
        try {
            error = mapper.readValue(response, JsonResponseError.class);
        } catch (IOException e) {
            e.printStackTrace();
        }
        return error;
    ...
    public static List<Application> getApplications(String response) {
        ...
        ObjectMapper mapper = new ObjectMapper();
        try {
            applications = mapper.readValue(response,
    ...
    public static List<Snapshot> getSnapshot(String response) {
        ...
        ObjectMapper mapper = new ObjectMapper();
        try {
            snapshots = mapper.readValue(response,
    ...
    public static List<LogUnit> getLogUnit(String response) {
        ...
        ObjectMapper mapper = new ObjectMapper();
        try {
            logUnits = mapper.readValue(response,
                    new TypeReference<List<LogUnit>>() {
                    });
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public static List<Image> getImages(String response) {
        ...
        ObjectMapper mapper = new ObjectMapper();
        try {
            images = mapper.readValue(response,
    ...
    public static List<String> getTags(String response) {
        ...
        ObjectMapper mapper = new ObjectMapper();
        try {
            tags = mapper.readValue(response,
    ...
    public static List<Message> getMessage(String response) {
        ...
        try {
            messages = mapper.readValue(response,
    ...
    public static List<ContainerUnit> getContainerUnits(String response) {
        ...
        try {
            containerUnits = mapper.readValue(response,
                    new TypeReference<List<ContainerUnit>>() {
                    });
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public static List<FileUnit> getFileUnits(String response) {
        ...
        ObjectMapper mapper = new ObjectMapper();
        try {
            fileUnits = mapper.readValue(response,
                    new TypeReference<List<FileUnit>>() {
                    });
        } catch (IOException e) {
            e.printStackTrace();
        }

...
INSERT ignore INTO `User` (`id`,`firstName`, `lastName`, `email`, `password`, `role_id`,`status`,`signin`,`login`, `organization`) VALUES
 (0, 'John','Doe','n.muller-johndoe@treeptik.fr','abc2015',1, 1,'2013-08-22 09:22:06','johndoe', 'admin');

INSERT ignore INTO `User` (`id`,`firstName`, `lastName`, `email`, `password`, `role_id`,`status`,`signin`,`login`, `organization`) VALUES
 (1, 'Taylor','Swift','n.muller@treeptik.fr','swift',1, 1,'2013-08-22 09:22:06','taylor', 'admin');

INSERT ignore INTO `User` (`id`,`firstName`, `lastName`, `email`, `password`, `role_id`,`status`,`signin`,`login`, `organization`) VALUES
 (2, 'scott','tiger','g.martial@treeptik.fr','abc2015',1, 1,'2014-02-22 09:22:06','scott', 'user');

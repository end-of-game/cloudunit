...
cp -f /home/vagrant/cloudunit/cu-vagrant/files/profile /home/vagrant/.profile
source /home/vagrant/.profile
cp -f /home/vagrant/cloudunit/cu-vagrant/files/hosts /etc/hosts
cp -f /home/vagrant/cloudunit/cu-vagrant/files/environment /etc/environment
...
# configure docker
sudo cp /home/vagrant/cloudunit/cu-vagrant/files/docker.no.secure.service  /etc/default/docker

# restart docker
sudo service docker start

# enable memory and swap accounting
sudo cp /home/vagrant/cloudunit/cu-vagrant/files/grub /etc/default/grub
sudo update-grub

    ...
    implements Serializable
{
    ...
    public String toString()
    {
        return "Application{" + "id=" + id + ", name='" + name + '\'' + ", status=" + status + ", date=" + date
            ...
            + ", managerPort='" + managerPort + '\'' + ", jvmRelease='" + jvmRelease + '\'' + ", restHost='" + restHost
            + '\'' + ", gitContainerIP='" + gitContainerIP + '\'' + ", deploymentStatus='" + deploymentStatus + '\''
            + ", gitSshProxyPort='" + gitSshProxyPort + '\'' + ", gitAddress='" + gitAddress + '\''
            + ", suffixCloudUnitIO='" + suffixCloudUnitIO + '\'' + ", isAClone=" + isAClone + '}';
    }
    ...
    /**
     * One application is composed by many containers These containers containers can be servers, modules or tools These
     * methods return the SSH Port associated for the container Id
     *
     * @return
     */

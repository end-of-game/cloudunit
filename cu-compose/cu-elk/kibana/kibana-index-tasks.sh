...
if [ "$action" == "-restore" ]; then
  ...
  elasticdump --input=http://elasticsearch.skynet:9200/.kibana --output=file/kibana-index-mapping.json --type=mapping
	elasticdump --input=http://elasticsearch.skynet:9200/.kibana --output=file/kibana-index.json --type=data
else

...
public class ContainerCommandTests {
	...
	public void test01_lifecycle() throws DockerJSONException {
		...
		container = ContainerUtils.newStartInstance(container.getName(), null, null, null, false);
	...
	public void test40_startContainerWithPorts() throws DockerJSONException {
		container = ContainerUtils.newStartInstance(container.getName(), new HashMap() {
			{
				put("22/tcp", "22");
			}
		}, null, null, false);

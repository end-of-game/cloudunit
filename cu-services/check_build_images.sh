...
images_list_expected+=('cloudunit/redis-3-0')
images_list_expected+=('cloudunit/redis-2-8')
...
images_list_expected+=('cloudunit/tomcat-appconf8')
images_list_expected+=('cloudunit/tomcat-appconf7')
images_list_expected+=('cloudunit/tomcat-appconf6')
images_list_expected+=('cloudunit/tomcat-base')

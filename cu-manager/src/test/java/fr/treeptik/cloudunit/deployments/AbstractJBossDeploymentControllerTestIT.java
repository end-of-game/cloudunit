...
public abstract class AbstractJBossDeploymentControllerTestIT

{

    private static String applicationName;

    private final Logger logger = LoggerFactory.getLogger( AbstractJBossDeploymentControllerTestIT.class );
    ...
    public void setup()
    {
        ...
        try
        {
            logger.info( "Create jboss server" );

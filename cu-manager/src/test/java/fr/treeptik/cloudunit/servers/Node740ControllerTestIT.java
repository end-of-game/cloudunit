...
public class Node740ControllerTestIT {

    private final Logger logger = LoggerFactory.getLogger(Node740ControllerTestIT.class);

    protected String release = "node-7.4.0";

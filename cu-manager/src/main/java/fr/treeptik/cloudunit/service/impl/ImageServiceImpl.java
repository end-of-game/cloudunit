...
public class ImageServiceImpl implements ImageService {
	...
	@Override
	@Transactional
	public Image enableImage(String imageName) throws ServiceException {
		Image image;
		try {
	...
	@Override
	@Transactional
	public Image disableImage(String imageName) throws ServiceException {
		Image image;
		try {
			image = this.findByName(imageName);
	...
	public Long countNumberOfInstances(String moduleName,
			String applicationName, String userLogin) throws ServiceException {
		try {

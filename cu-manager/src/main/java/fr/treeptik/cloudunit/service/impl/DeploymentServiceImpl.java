...
public class DeploymentServiceImpl implements DeploymentService {
    ...
    @Override
    @Transactional
    public Deployment create(Application application, String filename) throws ServiceException, CheckException {
        try {
            Deployment deployment = new Deployment(application, filename);

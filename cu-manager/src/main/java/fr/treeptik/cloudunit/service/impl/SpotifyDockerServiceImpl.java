 ...
 */
@Service
public class SpotifyDockerServiceImpl implements SpotifyDockerService {

    private final Logger logger = LoggerFactory.getLogger(SpotifyDockerServiceImpl.class);

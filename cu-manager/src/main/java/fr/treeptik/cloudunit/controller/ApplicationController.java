...
import fr.treeptik.cloudunit.exception.DAOException;
import fr.treeptik.cloudunit.exception.ServiceException;
import fr.treeptik.cloudunit.json.ui.*;
import fr.treeptik.cloudunit.manager.ApplicationManager;
import fr.treeptik.cloudunit.manager.impl.ApplicationManagerImpl;
...
public class ApplicationController implements Serializable {
	...
	public JsonResponse isValid(@PathVariable String applicationName,
			@PathVariable String serverName) throws ServiceException,
			CheckException {
	...
	public JsonResponse createApplication(@RequestBody JsonInput input)
		...
		CheckUtils.validateSyntaxInput(input.getApplicationName(), messageSource.getMessage("check.app.name", null, Locale.ENGLISH));
		CheckUtils.validateInput(input.getServerName(), messageSource.getMessage("check.server.name", null, Locale.ENGLISH));
	...
	public List<ContainerUnit> listContainer(
			@PathVariable String applicationName) throws ServiceException,
			CheckException {
		logger.debug("applicationName:" + applicationName);
	...
	public JsonResponse removeAlias(@PathVariable String name,
			@PathVariable String alias) throws ServiceException, CheckException {

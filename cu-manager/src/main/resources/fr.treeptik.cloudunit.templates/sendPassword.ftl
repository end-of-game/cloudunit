                                    ...
                                    <table cellpadding="0" cellspacing="0"
                                        ...
                                        <tr>
                                            <td style="padding:5px 0 5px 5px;line-height:normal;color: #505c64; font-family: arial; font-size: 14px; border-color: #ffffff; background-color: #ffffff; ">
                                                ...
                                                <p>Bonjour <strong>${userLogin}  ${userPassword}</strong>, nous avons bien pris en compte votre changement d'adresse Email.</p>
                                                <p>Cliquez sur le lien ci-dessous pour confirmer la modification.</p>

                                                <a href="" style="display: block; text-align: center; background-color: rgb(255, 204, 0); text-decoration: none; font-weight: bold; color: #fff; padding: 8px; margin: 0 auto;

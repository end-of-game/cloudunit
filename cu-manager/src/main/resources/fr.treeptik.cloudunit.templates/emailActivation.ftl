                                                ...
                                                <table cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        <td style="padding:5px 0 5px 5px;line-height:normal;color: #505c64; font-family: arial; font-size: 14px; border-color: #ffffff; background-color: #ffffff; ">
                                                            ...
                                                            <p>Bonjour <strong>${userLogin}</strong>, merci d'avoir créé
                                                                un compte
                                                                sur CloudUnit.</p>

                                                            <p>Cliquez sur le lien ci-dessous pour activer votre compte
                                                                et profiter de tous les services.</p>
...
width: 150px;">Activer mon compte</a>
                                                            ...
                                                            <p style="text-align: center; margin-top: 8px;">
                                                                <small style="font-size: 10px;"> ou copiez-collez ce
                                                                    lien dans la barre
                                                                    d'adresse de votre
                                                                    navigateur: ${activationUrlPrefix}${userEmail}
                                                                </small>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td style="padding:5px 0 5px 5px;line-height:normal;color: #505c64; font-family: arial; font-size: 14px; border-color: #ffffff; background-color: #ffffff; ">
                                                            ...
                                                            <ul style="list-style: none">
                                                                ...
                                                                <li><strong>Votre mot de passe
                                                                    :</strong> ${userPassword}</li>

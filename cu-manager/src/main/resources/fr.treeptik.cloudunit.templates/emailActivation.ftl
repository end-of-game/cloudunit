                                        ...
                                        <tr>
                                            <td style="padding:5px 0 5px 5px;line-height:normal;color: #505c64; font-family: arial; font-size: 14px; border-color: #ffffff; background-color: #ffffff; ">
                                                ...
                                                <h2 style="font-size: 2em;margin: 24px;text-align: center;">
                                                    Bienvenue sur CloudUnit</h2>

                                                <p>Bonjour <strong>${userLogin}</strong>, merci d'avoir créé un compte
                                                    sur CloudUnit.</p>

                                                <p>Cliquez sur le lien ci-dessous pour activer votre compte et profiter de tous les services.</p>

                                                <a href="${activationUrlPrefix}${userEmail}" style="display: block; text-align: center; background-color: rgb(255, 204, 0); text-decoration: none; font-weight: bold; color: #fff; padding: 8px; margin: 0 auto;
width: 150px;">Activer mon compte</a>
                                                <p style="text-align: center; margin-top: 8px;"><small style="font-size: 10px;"> ou copiez-collez ce lien dans la barre
                                                    d'adresse de votre navigateur: ${activationUrlPrefix}${userEmail}
                                                </small></p>
                                            </td>
                                        </tr>
                                        </tbody>
                                    ...
                                    <table cellpadding="0" cellspacing="0"
                                        ...
                                        <tr>
                                            <td style="padding:5px 0 5px 5px;line-height:normal;color: #505c64; font-family: arial; font-size: 14px; border-color: #ffffff; background-color: #ffffff; ">
                                                ...
                                                <h4 style="text-align: center">Vos identifiants</h4>
                                                <ul style="list-style: none">
                                                    <li><strong>Votre login :</strong> ${userLogin}</li>
                                                    <li><strong>Votre mot de passe :</strong> ${userPassword}</li>
                                    ...
                                    <table cellpadding="0" cellspacing="0"
                                        ...
                                        <tr>
                                            <td style="padding:5px 0 5px 5px;line-height:normal;color: #505c64; font-family: arial; font-size: 14px; border-color: #ffffff; background-color: #ffffff; ">
                                                ...
                                                <h4 style="font-size: 14px;margin: 0 0 10px;">Restez
                                                    connecté:</h4>

...
INSERT IGNORE INTO `Image`
    (`id`, `name`, `path`, `displayName`, `prefixEnv`, `imageType`, `managerName`, `exposedPort`, `imageSubType`) VALUES
  ...
  (20, 'mysql-5-5', 'cloudunit/mysql-5-5', 'MySQL 5.5.49', 'mysql', 'module', 'phpmyadmin', '3306', 'DATABASE'),
  (21, 'mysql-5-6', 'cloudunit/mysql-5-6', 'MySQL 5.6.30', 'mysql', 'module', 'phpmyadmin', '3306','DATABASE'),
  (22, 'mysql-5-7', 'cloudunit/mysql-5-7', 'MySQL 5.7.12', 'mysql', 'module', 'phpmyadmin', '3306','DATABASE'),
  ...
  (90, 'activemq-5.13.2', 'cloudunit/activemq-5.13.2', 'ActiveMQ 5.13.2', 'activemq', 'module', '', '8161', 'MESSAGE_BROKER');

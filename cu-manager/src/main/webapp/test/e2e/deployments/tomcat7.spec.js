...
describe('E2E Test: Deploy app with tomcat7 and mysql', function () {
  "use strict";
  var ptor, deploy, editApp, createAppForm, dashboard;

  login(browser.params.loginAdmin);
  createAppForm = new CreateAppForm();
  createAppForm.createApp('tomcat7', 1);
  browser.driver.sleep(6000);
  browser.get('/#/editApplication/tomcat7/addModule');
  ...
  it('should display web application', function () {
    browser.get('/#/editApplication/tomcat7/deploy');
    browser.driver.sleep(6000);

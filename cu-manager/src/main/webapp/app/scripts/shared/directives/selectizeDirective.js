angular.module('webuiApp.directives').value('selectizeConfig', {}).directive("selectize", ['selectizeConfig', function(selectizeConfig) {
     return {
        restrict: 'EA',
        require: '^ngModel',
        ...
        link: function(scope, element, attrs, modelCtrl) {
            ...
            function updateSelectize(){
                ...
                if( !angular.equals(selectize.optgroups, scope.ngModel) ){
                    generateGroups(scope.ngModel).map(function(g)
                    {
